...
with open(os.path.join(top_dir, "annotate", "__about__.py")) as f:
...
if about.__version_info__.releaselevel != "final":
    release += about.__version_info__.releaselevel
...
texinfo_documents = [
    (master_doc, project_, project + ' Documentation',
     author, project_, 'One line description of project.',
     'Miscellaneous'),
]
